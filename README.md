...
```
<link rel="stylesheet" href="https://cdn.antwerpen.be/acpaas_branding_scss/3.0.3/main.min.css">
```

You can even import it directly in your (S)CSS:

```
@import url("https://cdn.antwerpen.be/acpaas_branding_scss/3.0.3/main.min.css");
```
